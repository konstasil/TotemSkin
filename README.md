...
- **Per-player config** - set custom or vanilla totem mode for individual players via Cloth Config
...
- **Languages**  -  English, Russian, Polish, German, French, Spanish, Portuguese
...
3. (Optional) Install Cloth Config for the config screen

## Configuration

Open Mods > TotemSkin > Config to access settings:
